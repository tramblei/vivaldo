...
CONFIG.WUSER_BITS_PER_BYTE {0} \
  ...
  # Create ports
  set S04_AXI_araddr [ create_bd_port -dir I -from 31 -to 0 S04_AXI_araddr ]
  set S04_AXI_arburst [ create_bd_port -dir I -from 1 -to 0 S04_AXI_arburst ]
  set S04_AXI_arcache [ create_bd_port -dir I -from 3 -to 0 S04_AXI_arcache ]
  set S04_AXI_arlen [ create_bd_port -dir I -from 7 -to 0 S04_AXI_arlen ]
  set S04_AXI_arlock [ create_bd_port -dir I -from 0 -to 0 S04_AXI_arlock ]
  set S04_AXI_arprot [ create_bd_port -dir I -from 2 -to 0 S04_AXI_arprot ]
  set S04_AXI_arqos [ create_bd_port -dir I -from 3 -to 0 S04_AXI_arqos ]
  set S04_AXI_arready [ create_bd_port -dir O S04_AXI_arready ]
  set S04_AXI_arsize [ create_bd_port -dir I -from 2 -to 0 S04_AXI_arsize ]
  set S04_AXI_arvalid [ create_bd_port -dir I S04_AXI_arvalid ]
  set S04_AXI_rdata [ create_bd_port -dir O -from 31 -to 0 S04_AXI_rdata ]
  set S04_AXI_rlast [ create_bd_port -dir O S04_AXI_rlast ]
  set S04_AXI_rready [ create_bd_port -dir I S04_AXI_rready ]
  set S04_AXI_rresp [ create_bd_port -dir O -from 1 -to 0 S04_AXI_rresp ]
  set S04_AXI_rvalid [ create_bd_port -dir O S04_AXI_rvalid ]
